...
@DriftDatabase(
  tables: [Users, WaterGoals, WaterEntries],
  daos: [UsersDao, WaterGoalsDao, WaterEntriesDao],
)
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
    ...
    onUpgrade: (m, from, to) async {
      ...
      // rows in earlier tables (Users, WaterGoals) are never touched.
      if (from < 2) {
    ...
    beforeOpen: (details) async {
      // Same as before: WaterGoals.userId and WaterEntries.userId both
      // reference Users.id, so foreign keys must stay enforced.
